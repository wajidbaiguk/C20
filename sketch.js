...
function setup(){
    ...
    particle8 =Bodies.circle(260,10,10,particle_options);
    World.add(world,particle8);

    particle9 =Bodies.circle(246,10,10,particle_options);
    World.add(world,particle9);

    particle10 =Bodies.circle(254,10,10,particle_options);
